...
function SeasonPage({ id, handleKartEvent, isHome = false , type}) {
  const navigate = useNavigate();
  const eventType = type === "E-Bike" ? bikeEvents[id]: kartEvents[id];
  return (
    <>
                ...
                <div className="">
                  ...
                  <div className=" mt-8">
                    <ul className=" text-neutral md:text-sm text-xs font-body list-disc uppercase ml-4 font-semibold">
                      {eventType.data.subHeading.map((i) => (
